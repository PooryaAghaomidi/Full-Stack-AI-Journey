...
- **Function:** Provides an endpoint for sending or receiving data over a network using protocols like TCP or UDP.
- **Use Case:** Enables communication between applications on different devices, such as a client and a server exchanging data.
